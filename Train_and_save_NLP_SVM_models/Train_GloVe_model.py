...
# Vectorize the text data using the mean GloVe vector
df_balanced['Message'] = df_balanced['Message'].apply(lambda x: vectorize_text_glove(x, embeddings_index))
...
grid_search = GridSearchCV(glove_svm, parameters, cv=5)
grid_search.fit(X_train_imputed, y_train)

# Save the trained model
joblib.dump(grid_search.best_estimator_, 'glove_svm_model.pkl')
...
print("Accuracy score using GloVe:", accuracy)
print("Precision score using GloVe:", precision)
print("Recall score using GloVe:", recall)
print("F1 score using GloVe:", f1)